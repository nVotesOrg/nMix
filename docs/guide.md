...
- [nMix User Guide](#nmix-user-guide-1)
	- [Overview](#overview-1)
		- [Components](#components-1)
		- [Protocol](#protocol-1)
		- [Bulletin board structure](#bulletin-board-structure-1)
	- [Installing](#installing-1)
		- [Requirements](#requirements-1)
		- [Keys](#keys-1)
		- [Bulletin Board setup](#bulletin-board-setup-1)
		- [Trustee setup](#trustee-setup-1)
	- [Running an election](#running-an-election-1)
		- [Election configuration](#election-configuration-1)
	- [Artifact reference](#artifact-reference-1)
	- [FAQ](#faq-1)
		- [Is nMix 100% secure?](#is-nmix-100%25-secure-1)
		- [Is nMix end-to-end verifiable?](#is-nmix-end-to-end-verifiable-1)
		- [Where can I find a formal specification of the system?](#where-can-i-find-a-formal-specification-of-the-system-1)
		- [What about the use of SHA1 in the Git hash chain?](#what-about-the-use-of-sha1-in-the-git-hash-chain-1)
		- [What about the Registry, Ballotbox and Voting Booth? Where can I find them?](#what-about-the-registry-ballotbox-and-voting-booth-where-can-i-find-them-1)
		- [Does nMix include a threshold cryptosystem?](#does-nmix-include-a-threshold-cryptosystem-1)
		- [Could you replace the Git bulletin board with a Blockchain/IPFS/Tahoe-Lafs/Swarm?](#could-you-replace-the-git-bulletin-board-with-a-blockchainipfstahoe-lafsswarm-1)
		- [Where can I ask more questions?](#where-can-i-ask-more-questions-1)
...
Ask your question on the [mailing list](https://groups.google.com/forum/#!forum/nmix-voting) and we'll add it to this FAQ.![alt text](http://davidruescas.com/wp-content/uploads/2017/04/nMix.png)
